...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand('extension.qemu-gdb-debugger.runEditorContents', (resource: vscode.Uri) => {
		...
		vscode.commands.registerCommand('extension.qemu-gdb-debugger.debugEditorContents', (resource: vscode.Uri) => {
			vscode.debug.startDebugging(undefined, {
				type: 'mock',
